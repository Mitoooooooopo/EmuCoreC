...
class SDLControllerManager {
    companion object {
        ...
        @JvmStatic
        fun updateRuntimeInputSettings(config: Ps3CoreConfig) {
...
private object GamepadRuntimeInputSettings {
    ...
    private data class Values(
        ...
        val buttonProfile: String = Ps3CoreConfig.GAMEPAD_PROFILE_STANDARD,
    ...
    fun update(config: Ps3CoreConfig) {
        cached = Values(
    ...
    fun mapButton(keycode: Int): Int {
        return when (current().buttonProfile) {
            Ps3CoreConfig.GAMEPAD_PROFILE_SWAP_CROSS_CIRCLE -> when (keycode) {
                KeyEvent.KEYCODE_BUTTON_A -> KeyEvent.KEYCODE_BUTTON_B
                KeyEvent.KEYCODE_BUTTON_B -> KeyEvent.KEYCODE_BUTTON_A
                else -> keycode
            }
            Ps3CoreConfig.GAMEPAD_PROFILE_NINTENDO_FACE -> when (keycode) {
                KeyEvent.KEYCODE_BUTTON_A -> KeyEvent.KEYCODE_BUTTON_B
                KeyEvent.KEYCODE_BUTTON_B -> KeyEvent.KEYCODE_BUTTON_A
